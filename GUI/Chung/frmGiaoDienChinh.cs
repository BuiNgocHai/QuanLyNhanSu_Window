...
namespace QuanLyNhanSu_Nhom6.Views
{
    public partial class frmDashboard : Form
    {
      ...
      (
        ...
        {
            moFrmCon(new frmThongKeTrinhDoChuyenMon());
        }
        ...
        private void btnDMPB_Click(object sender, EventArgs e)
        {
            moFrmCon(new frmQLDanhMucPhongBan());
        }

        private void btnDMCV_Click(object sender, EventArgs e)
        {
            moFrmCon(new frmQuanLyChucVu());
        }

        private void btnHoSoNV_Click(object sender, EventArgs e)
        {
            moFrmCon(new frmQuanLyHoSo());
        }

        private void btnTrinhDoChuyenMon_Click(object sender, EventArgs e)
        {
            moFrmCon(new frmQuanLyTrinhDoChuyenMon());
        }
